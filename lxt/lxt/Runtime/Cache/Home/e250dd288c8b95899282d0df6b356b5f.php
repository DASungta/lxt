...
<body id="login">
  ...
  <div class="app-cam">
	  <form method="post" action="<?php echo U('Home/Login/handle');?>">
		<input type="text" name="mid" class="text" onfocus="this.value = '';" placeholder="会员名称/会员ID">
		<input type="password" name="pwd" placeholder="密码" onfocus="this.value = '';">
		<div class="submit"><input type="submit" onclick="myFunction()" value="Login"></div>
		
		<ul class="new">
			<li class="new_left"><p><a href="<?php echo U('Admin/Login/index');?>"> 后台登陆</a></p></li>
