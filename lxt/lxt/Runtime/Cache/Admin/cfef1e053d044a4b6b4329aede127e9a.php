...
<div id="wrapper">
	   ...
	   <div class="xs">
  	 <h3><span class="label label-success">会员等级列表</span>&nbsp;<a href="<?php echo U('Admin/Member/addMemberStatus');?>"><button type="button" class="btn btn-xs btn-success warning_4">&nbsp;+&nbsp; </button></a></h3>
     <div class="table-responsive">
      <table class="table">
        ...
        <tbody>
          <?php if(is_array($memberstatus)): foreach($memberstatus as $key=>$v): ?><tr>
              <th scope="row"><?php echo ($key+1); ?></th>
              <td><?php echo ($v["title"]); ?></td>
              <td><?php echo ($v["getrule"]); ?></td>
              <td><?php echo ($v["repayrule"]); ?></td>
              <td><?php echo ($v["cashrule"]); ?></td>
              <td><?php echo ($v["buyrule"]); ?></td>
              <td><button type="button" class="btn btn-xs btn-warning warning_44"><a href="<?php echo U('Admin/Member/updateMemberStatus',array('id'=>$v['id']));?>" style="color:white;font-size:15px">修改</a></button></td>
