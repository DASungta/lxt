...
<div id="wrapper">
	   ...
	   <div class="xs">
  	 <h3><span class="label label-success">订单列表</span>&nbsp;<a href="<?php echo U('Admin/Order/addOrder');?>"><button type="button" class="btn btn-xs btn-success warning_4">&nbsp;+&nbsp; </button></a></h3></div>
     <?php echo ($mid); ?>
    <table class="table">
      <thead>
        <tr>
      ...
      <tbody>
        <?php if(is_array($order)): foreach($order as $key=>$v): ?><tr class="active">
            <th scope="row"><?php echo ($v["id"]); ?></th>
            <td><span class="label label-warning" style='font-size:13px'><?php echo ($v["oid"]); ?></span></td>
            <td><?php echo ($v["membername"]); ?></td>
            <td><?php echo ($v["createtime"]); ?></td>
            <td><?php echo ($v["money"]); ?></td>
            <td><?php echo ($v["detail"]); ?></td>
            <td><button type="button" class="btn btn-xs btn-info"><a style="color:white;font-size:15px" href="<?php echo U('Admin/Order/viewDetail',array('oid'=>$v['oid']));?>">查看详情</a></button></td>
