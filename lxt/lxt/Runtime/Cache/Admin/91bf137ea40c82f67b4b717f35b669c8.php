<?php if (!defined('THINK_PATH')) exit();?><span class="label label-success"><!DOCTYPE HTML>
<html>
<head>
<title>修改会员等级</title>
...
<div id="wrapper">
        ...
        <div class="graphs">
	     <div class="xs">
  	       <h3><span class="label label-success">修改会员等级</h3>
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
						<?php if(is_array($memberdata)): foreach($memberdata as $key=>$st): ?><form class="form-horizontal" method="post" action="<?php echo U('Admin/Member/updateMemberStatusHandle',array('id'=>$st['id']));?>">
							
								<div class="form-group">
									<label for="disabledinput" class="col-sm-2 control-label">会员等级</label>
									<div class="col-sm-8">
										<input type="text" name="memberStatusName" class="form-control1" id="disabledinput" value="<?php echo ($st['title']); ?>">
									</div>
								</div>
								<div class="form-group">
									<label for="disabledinput" class="col-sm-2 control-label">积分获得规则</label>
									<div class="col-sm-8">
										<input type="text" name="getRule" class="form-control1" id="disabledinput" value="<?php echo ($st['getrule']); ?>">
									</div>
								</div>
								<div class="form-group">
									<label for="selector1" class="col-sm-2 control-label">返还规则</label>
									<div class="col-sm-8">
										<select name="repayRuleId" id="selector1" class="form-control1">
											<option>请选择</option>
											<?php if(is_array($statusData)): foreach($statusData as $key=>$v): ?><option value="<?php echo ($v['id']); ?>"><?php echo ($v["state"]); ?></option><?php endforeach; endif; ?>
										</select>
									</div>
								</div>
								<div class="form-group">
									<label for="disabledinput" class="col-sm-2 control-label">提现规则</label>
									<div class="col-sm-8">
										<input type="text" name="cashRule" class="form-control1" id="disabledinput" value="<?php echo ($st['cashrule']); ?>">
									</div>
								</div>
								<div class="form-group">
									<label for="disabledinput" class="col-sm-2 control-label">拿货规则</label>
									<div class="col-sm-8">
										<input type="text" name="buyRule" class="form-control1" id="disabledinput" value="<?php echo ($st['buyrule']); ?>">
									</div>
								</div>
