...
<!-- Graph CSS -->
<link href="/lxt/Public/Admin/css/lines.css" rel='stylesheet' type='text/css' />
...
<!-- Graph JavaScript -->
<script src="/lxt/Public/Admin/js/d3.v3.js"></script>
<script src="/lxt/Public/Admin/js/rickshaw.js"></script>
</head>
<body>
<div id="wrapper">
          <!-- Navigation -->
        ...
        <strong>教程！</strong> 首先请于会员系统>添加返还规则，再于会员系统>添加会员等级，最后添加会员。
       </div>
     	<div class="col_3">
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong><?php echo ($o_count); ?></strong></h5>
                      <span>订单</span>
                    </div>
                </div>
        	</div>
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong><?php echo ($m_count); ?></strong></h5>
                      <span>会员</span>
                    </div>
                </div>
        	</div>
			...
			<div class="col-md-4 stats-info">
                ...
                <div class="panel-body">
                    <ul class="list-unstyled">
	                    <?php if(is_array($order)): foreach($order as $key=>$v): ?><li><?php echo ($v["detail"]); ?><div class="text-success pull-right"><?php echo ($v["membername"]); ?></div></li><?php endforeach; endif; ?>
                    </ul>
                </div>
            </div>
            <div class="clearfix"> </div>
	  ...
	  <div class="span_11">
		<div class="col-md-6 col_4">
		  ...
		  <!----Calender -------->
			<link rel="stylesheet" href="/lxt/Public/Admin/css/clndr.css" type="text/css" />
			<script src="/lxt/Public/Admin/js/underscore-min.js" type="text/javascript"></script>
			<script src= "/lxt/Public/Admin/js/moment-2.2.1.js" type="text/javascript"></script>
			<script src="/lxt/Public/Admin/js/clndr.js" type="text/javascript"></script>
			<script src="/lxt/Public/Admin/js/site.js" type="text/javascript"></script>
			<!----End Calender -------->
		</div>
...
var detail = new Rickshaw.Graph.HoverDetail({
	graph: graph
	      ...
	      <!-- map -->
<link href="/lxt/Public/Admin/css/jqvmap.css" rel='stylesheet' type='text/css' />
<script src="/lxt/Public/Admin/js/jquery.vmap.js"></script>
<script src="/lxt/Public/Admin/js/jquery.vmap.sampledata.js" type="text/javascript"></script>
<script src="/lxt/Public/Admin/js/jquery.vmap.world.js" type="text/javascript"></script>
