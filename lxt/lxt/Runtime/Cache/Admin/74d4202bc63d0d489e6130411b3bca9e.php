...
<div id="wrapper">
	   ...
	   <div class="xs">
  	 <h3><span class="label label-success">兑换申请列表</span></h3>
          ...
          <table class="table table-striped">
            ...
            <tbody>
              <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
                  ...
                  <td>
                  <!-- <?php echo U('Admin/Cash/getExchange',array('id'=>$v['id']));?> -->
                      <button type="button" class="btn btn-sm btn-info"  data-toggle="modal" data-target="#myModal<?php echo ($v['id']); ?>" style="margin:-10px">同意</button>
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                         <div class="alert alert-warning" role="alert">
                          <strong>提醒！</strong>请输入此会员兑换的物品！（可为空）
                         </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="row">
                                <div class="col-md-11 grid_box1" style="margin-left:25px;margin-right:-15px">
                                  <input type="text" name="detail" class="form-control1" id="disabledinput">
