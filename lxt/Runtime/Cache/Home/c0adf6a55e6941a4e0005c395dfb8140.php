  	       ...
  	       <h3>修改信息</h3>
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" method="post" action="<?php echo U('Home/Member/updataInfoHandle');?>">
							<?php if(is_array($data)): foreach($data as $key=>$v): ?><!-- <div class="form-group">
									...
									<div class="col-md-8">
										<div class="input-group">
											...
											<input type="password" name="pwd" class="form-control1" id="exampleInputPassword1" >
										</div>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-8">
										<div class="input-group">
											...
											<input type="password" name="pwd2" class="form-control1" id="exampleInputPassword1" >
										</div>
									</div>
								</div> -->
								<div class="form-group">
