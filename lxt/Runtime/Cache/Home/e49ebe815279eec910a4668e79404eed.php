             ...
             <div class="col-md-4 widget_1_box1">
                ...
                <div class="coffee-top">
                    ...
                    <div class="doe">
                        ...
                        <p style="color:white"><?php echo ($memberstatus); ?></p>
                        <p style="color:yellow">冻结:<?php echo ($left_money); ?></p>
                    </div>
                    <i></i></a>
                </div>
                <div class="follow">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                         <div class="alert alert-warning" role="alert">
                          <strong>提醒！</strong>您是<?php echo ($memberstatus); ?>，提现额度为<?php echo ($cashrule*10*10); ?>%，可提现积分为<?php echo ($get_money); ?>
                         </div>
