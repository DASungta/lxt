...
<div id="wrapper">
        ...
        <div class="graphs">
	     <div class="xs">
  	       <h3><span class="label label-success">修改返还规则</h3>
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
						<?php if(is_array($data)): foreach($data as $key=>$v): ?><form class="form-horizontal" method="post" action="<?php echo U('Admin/Member/updateRepayRuleHandle',array('id'=>$v['id']));?>">
								<div class="form-group">
									<label for="disabledinput" class="col-sm-2 control-label">规则编号</label>
									<div class="row">
										<div class="col-md-3 grid_box1">
											<input disabled="" type="text" name="rule_id" class="form-control1" id="disabledinput" value="<?php echo ($v['id']); ?>">
										</div>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="row">
										<div class="col-md-3 grid_box1">
											<input type="text" class="form-control1" id="disabledinput" name="day" value="<?php echo ($v['day']); ?>">
										</div>
								...
								<div class="form-group">
									...
									<div class="row">
										<div class="col-md-3 grid_box1">
											<input type="text" class="form-control1" id="disabledinput" name="times" value="<?php echo ($v['times']); ?>">
										</div>
								...
								<div class="form-group">
									...
									<div class="row">
										<div class="col-md-3 grid_box1">
											<input type="text" class="form-control1" id="disabledinput" name="state" value="<?php echo ($v['state']); ?>">
										</div>
