...
<div id="wrapper">
	   ...
	   <div class="xs">
  	 <h3><span class="label label-success">兑换记录</span></h3>
          ...
          <table class="table table-striped">
            ...
            <tbody>
              <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
                  ...
                  <td>
                    <button type="button" class="btn btn-sm btn-info"  data-toggle="modal" data-target="#myModal<?php echo ($v['id']); ?>" style="margin:-10px">详情</button>
                      <div class="modal fade" id="myModal<?php echo ($v['id']); ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                    <form class="form-horizontal" method="post" action="<?php echo U('Admin/Cash/getExchange',array('id'=>$v['id']));?>">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                          <h2 class="modal-title">兑换详情</h2>
                        </div>
                        <div class="modal-body">
                         <div class="alert alert-warning" role="alert">
                          <strong>提醒！</strong>此为会员兑换的物品！（可为空）更改后可直接保存
                         </div>
                          
                            <div class="form-group">
                             
                              <div class="row">
                                <div class="col-md-11 grid_box1" style="margin-left:25px;margin-right:-15px">
                                  <input type="text" name="detail" class="form-control1" id="disabledinput" value="<?php echo ($v['detail']); ?>">
